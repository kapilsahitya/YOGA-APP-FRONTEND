          ...
          <Row className="d-flex align-items-center">
            <Col xs={12} lg={6} className="mb-4">
              <div className="d-none d-lg-block mt-5">
                ...
                <Button as={Link} to={RoutesData.DocsFolderStructure.path} variant="secondary" size="md" target="_blank" className="text-dark">
          ...
          <Row className="justify-content-center">
            <Col md={10} xl={9}>
              ...
              <p className="mt-4 text-white text-center mb-0">
                Looks unfamiliar? Don’t worry! Our <Link to={RoutesData.DocsQuickStart.path} className="text-white text-underline fw-bold" target="_blank">documentation</Link> has got you covered.
              </p>
            </Col>
          </Row>
        </Container>
